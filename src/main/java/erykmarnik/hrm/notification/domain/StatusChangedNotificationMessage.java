...
class StatusChangedNotificationMessage implements NotificationMessageHandler {
  private static final String KEY = "assignment.statusChanged";
  private static final String SUBJECT_KEY = "assignment.statusChanged.subject";
  ...
  public boolean supports(MessageType messageType) {
    return messageType.equals(MessageType.STATUS_CHANGED);
  }
}
